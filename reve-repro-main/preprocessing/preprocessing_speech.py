...
train_dir = PATHS["speech"]["train"]
val_dir = PATHS["speech"]["val"]
test_dir = PATHS["speech"]["test"]
...
df = pd.read_excel(PATHS["speech"]["excel"])
...
os.makedirs(PATHS["speech"]["processed"], exist_ok=True)
db = lmdb.open(PATHS["speech"]["processed"], map_size=3000000000)
