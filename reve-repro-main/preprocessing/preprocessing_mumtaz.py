...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--root",
        type=str,
        default=PATHS["mumtaz"]["root"],
        help=f"Root directory of the dataset, defaults to {PATHS['mumtaz']['root']}",
    )
    parser.add_argument(
        "--processed",
        type=str,
        default=PATHS["mumtaz"]["processed"],
        help=f"Directory to save the processed dataset, defaults to {PATHS['mumtaz']['processed']}",
    )
    parser.add_argument(
        "--type",
        type=str,
