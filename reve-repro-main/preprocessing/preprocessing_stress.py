...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--root",
        type=str,
        default=PATHS["stress"]["root"],
        help=f"Root directory of the stress dataset, defaults to {PATHS['stress']['root']}",
    )
    parser.add_argument(
        "--processed",
        type=str,
        default=PATHS["stress"]["processed"],
        help=f"Directory to save the processed data, defaults to {PATHS['stress']['processed']}",
    )
    parser.add_argument(
        "--type",
        type=str,
