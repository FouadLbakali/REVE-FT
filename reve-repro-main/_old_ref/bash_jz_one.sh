...
--n_gpus 2 --n_nodes 2 --num_workers 32 --batch_size 64 \
--depth 22 --heads 12 --decoder_depth 4 --decoder_heads 8 --embed_dim 512 --decoder_dim 512 \
--mlp_dim_ratio 2.66 --n_cycles 1 --peak_lr 4e-5 --adamw_beta1 0.9 --adamw_beta2 0.95 \
--tag 'all' --comment 'reload_beta_full_12_8_4_8_512' --save_model_path '/lustre/fsn1/projects/rech/lnb/uby38mh/models' \
