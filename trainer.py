...
def train_loop(model, train_loader, val_loader, optimizer, epochs, device,
               l1=0.0, label="", save_module=None, scheduler_name="plateau"):
    """Standard train/val loop: returns the state_dict of save_module at its best
    validation balanced_acc. save_module defaults to the full model."""
    ...
    for epoch in range(epochs):
        ...
        _, train_acc = train_one_epoch(model, optimizer, train_loader, device, l1_lambda=l1)
